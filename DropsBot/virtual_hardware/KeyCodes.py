class KeyCodes:
	...
	###########################################
	# Keyboard control/modifier keys
	# - = 0x07                 # Undefined
	...
	PRINT               = 0x2A # PRINT key - this is literally send to a printer
	...
	###########################################
	# More keyboard control keys 
	LEFTWIN             = 0x5B # Left Windows key (Natural keyboard)
	RIGHTWIN            = 0x5C # Right Windows key (Natural keyboard)
	...
	###########################################
	# Extra application control keys - fn events
	...
	###########################################
	# Locale speficic keys (mainly punctuation)
	# - = 0xB8-B9              # Reserved
	...
	# - = 0xE0                 # Reserved
	#ZERO = 0xE1               # OEM specific
	OEM_102             = 0xE2 # Either the angle bracket key or the backslash key on the RT 102-key keyboard
	# 0xE3 =-E4                # OEM pecific
	PROCESSKEY          = 0xE5 # IME PROCESS key
	#ZERO = 0xE6               # OEM specificPACKET 0xE7                          # Used to pass Unicode characters as if they were keystrokes. The PACKET key is the low word of a 32-bit Virtual Key value used for non-keyboard input methods. For more information, see Remark in KEYBDINPUT, SendInput, WM_KEYDOWN, and WM_KEYUP
	# - = 0xE8                 # Unassigned
